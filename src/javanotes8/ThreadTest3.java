 ...
 * chosen by the user.
 * 
 * This is a slightly modified version of javanotes8.ThreadTest2.  It uses an AtomicInteger
 * object to add up the total number of primes found by the various threads.
 * javanotes8.ThreadTest2 used an ordinary int variable and used synchronization to handle
...
public class ThreadTest3 {
     ...
     * among the threads.
     */
    private static final int START = 3_000_000;
